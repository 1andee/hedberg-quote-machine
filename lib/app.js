$(() => {
  ...
  function renderQuote() {
    ...
    if (quote.length + signature.length <= 140) {
      ...
      $("#mitch").append(`<a href="${prefix}${convertedQuote}${convertedSignature}" target="_blank"><img src="./assets/twitter.png" width="50px" /></a>`);

      $("#mobile-only-tweet-button").append(`Tweet it! <a href="${prefix}${convertedQuote}${convertedSignature}" target="_blank"><img src="./assets/twitter.png" width="50px" /></a>`);
    };
  };
